...
| **[mobilggbsonbildirim.user.js](mobilggbsonbildirim.user.js)** | Mobil görünümde gizlenen Gümrük Başvuru No ve Tarihi sütunlarını görünür hale getirir, gereksiz onay sütunlarını kaldırır, Ön Bildirim No (Bildirim No) ve Gümrük Başvuru No (ID No) sütunlarını en başa alarak sabitler. | 2.3 |
