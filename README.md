...
| **[mobilggbsonbildirim.user.js](mobilggbsonbildirim.user.js)** | Mobil görünümde gizlenen Gümrük Başvuru No sütununu görünür yapar, captcha alanını otomatik doldurur ve Ön Bildirim No yanına, tıklandığında ID'yi panoya kopyalayan şık bir "ID" butonu ekler. | 3.0 |
